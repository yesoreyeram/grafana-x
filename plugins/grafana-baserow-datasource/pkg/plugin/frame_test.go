...
func TestRecordsToFrame_PreservesRowOrder(t *testing.T) {
	// The frame layer must NOT re-sort rows: the order returned by Baserow (which
...
func TestRecordsToFrame_OffsetDateTimeNormalisedToUTC(t *testing.T) {
	// Baserow may return datetime with a zone offset; the instant must be preserved
...
func TestRecordsToFrame_CheckboxStaysNumeric(t *testing.T) {
	// Boolean-like 1/0 numeric values should remain numeric (a 0/1
...
func TestToTime_BaserowDateTimeFormats(t *testing.T) {
	cases := []string{
		"2026-06-15 09:30:55+00:00", // datetime, UTC
		"2026-06-15 09:30:55+05:30", // datetime, offset zone
