...
describe('FilterEditor', () => {
  ...
  it('renders existing condition rows', () => {
    const group: FilterGroup = {
      kind: 'group',
      connector: 'and',
      children: [{ kind: 'condition', field: 'Age', op: 'higher_than', value: '30' }],
    };
  ...
  it('shows an editable connector control from the second row onward', () => {
    const group: FilterGroup = {
      ...
      connector: 'and',
      children: [
        { kind: 'condition', field: 'Age', op: 'higher_than', value: '30' },
        { kind: 'condition', field: 'Age', op: 'lower_than', value: '10' },
      ],
    };
    render(<FilterEditor group={group} fields={fields} onChange={() => {}} />);
