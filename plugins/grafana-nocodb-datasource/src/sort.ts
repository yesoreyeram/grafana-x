...
/**
 * Parse a NocoDB `sort` string into structured sort items. The NocoDB API
 * encodes sort as a comma-separated list of field names where a leading `-`
 * marks a descending sort, e.g. `-CreatedAt,Title`.
 */
...
/**
 * Serialize structured sort items back into the NocoDB `sort` string. Items
