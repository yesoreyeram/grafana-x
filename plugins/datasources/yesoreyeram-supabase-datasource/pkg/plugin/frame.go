...
// Data plane contract type versions.
var (
...
// recordsToFrame converts a slice of Supabase records (flat JSON maps) into a
// single wide data.Frame conforming to the data plane "table" contract.
