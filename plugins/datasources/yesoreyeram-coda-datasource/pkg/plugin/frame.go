...
func rowsToFrame(refID string, records []map[string]any) *data.Frame {
...
// identityColumns are the synthetic row-metadata columns produced by
// flattenRows. They are ordered first (before data columns), though time-typed
// ones (createdAt/updatedAt) are subsequently moved to the very front by
// orderTimeFirst.
var identityColumns = []string{"id", "name", "index", "createdAt", "updatedAt", "href", "browserLink"}
