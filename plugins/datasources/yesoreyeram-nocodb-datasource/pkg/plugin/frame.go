...
// recordsToFrame converts a slice of NocoDB records (arbitrary JSON objects)
// into a single wide data.Frame conforming to the data plane "table" contract.
//
// Row order is preserved exactly as returned by NocoDB, so the query's `sort`
...
var timeLayouts = []string{
	time.RFC3339Nano,
	time.RFC3339,
	// NocoDB DateTime columns render with a space separator and a numeric zone,
	// e.g. "2026-06-15 09:30:55+00:00" or "2026-06-15 09:30:55+05:30".
