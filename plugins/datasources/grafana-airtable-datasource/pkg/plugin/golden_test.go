...
// Airtable responses match the committed golden files. These lock down the full
...
func TestGolden_Frames(t *testing.T) {
	t.Run("records_mixed_types", func(t *testing.T) {
		records := []map[string]any{
			{"_id": "rec1", "Name": "Alice", "Active": true, "MRR": float64(49.5), "SignedUp": "2024-01-15"},
			{"_id": "rec2", "Name": "Bob", "Active": false, "MRR": float64(0), "SignedUp": "2024-02-20"},
		}
