...
```bash
yarn workspace @yesoreyeram/grafana-vizard-panel build   # produces dist/
```
...
docker compose -f plugins/panel/grafana-vizard-panel/docker-compose.yaml up
...
GEN_GALLERIES=true yarn workspace @yesoreyeram/grafana-vizard-panel test src/spec/galleries.test.ts
# Showcase + logo dashboards
node plugins/panel/grafana-vizard-panel/scripts/gen-showcase.mjs
node plugins/panel/grafana-vizard-panel/scripts/gen-logo.mjs
```
